  ...
  return (
    ...
    >
      ...
      <g fill={`url(#${id}-cg)`} stroke={`url(#${id}-cg)`}>
        <path d="M4 4c10 0 16 0 22 1.4-7 1.2-12 6-13 13C11.8 8.4 11.8 8.4 4 4z" stroke="none" opacity="0.98" />
        ...
        <path d="M17 17c11-2 19 1 22 6 2.2 4-.6 8-4.6 6.6-3-1-2.2-5 .8-3.8" strokeWidth="2" strokeLinecap="round" fill="none" />
        <path d="M17 17c-2 11 1 19 6 22 4 2.2 8-.6 6.6-4.6-1-3-5-2.2-3.8.8" strokeWidth="2" strokeLinecap="round" fill="none" />
        <path d="M22 8c4-3.4 9-3.4 13-1.2M8 22c-3.4 4-3.4 9-1.2 13" strokeWidth="1.5" strokeLinecap="round" fill="none" opacity="0.9" />
        <path d="M30 7c3-2 6.5-2 9.5-.6M7 30c-2 3-2 6.5-.6 9.5" strokeWidth="1.2" strokeLinecap="round" fill="none" opacity="0.7" />
...
export function ArchiveToggle<T extends string>({ options, value, onChange, className, framed = true }: ArchiveToggleProps<T>) {
  ...
  if (manualOnlyToggle) return null
