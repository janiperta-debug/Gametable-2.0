...
export const ROOM_THEME_PAGES: Record<string, RoomThemePage> = {
  ...
  observatory: {
    ...
    artifact: { name: { fi: "Tähtikartan sirpale", en: "Star Chart Fragment" }, image: "/themes/artifacts/observatory.png", description: [{ fi: "Tuntemattoman kartoittamiseen käytetyn tähtikartan sirpale.", en: "A fragment of a chart once used to map the unknown." }] },
