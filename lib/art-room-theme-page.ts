...
export const ART_ROOM_THEME_PAGE: RoomThemePage = {
  ...
  storyParagraphs: [
    {
      fi: "Täällä mielikuvitus saa muodon ja ideat löytävät siipensä.",
      en: "Here, imagination takes shape and ideas find their form.",
    },
    {
      fi: "Jokainen siveltimen veto, jokainen viiva ja jokainen sana on uusi tapa ymmärtää maailmaa.",
      en: "Every brushstroke, every line, and every word is a new way of understanding the world.",
    },
    {
      fi: "Ei ole yhtä oikeaa tapaa luoda — on vain sinun tapasi.",
      en: "There is no single way to create—only your way.",
    },
    {
      fi: "Nosta työkalu. Luota visioosi. Anna jonkin ainutlaatuisen syntyä.",
      en: "Pick up a tool, trust your vision, and let something unique be born.",
    },
  ],
  essenceTagline: {
    fi: "Luovuus paljastaa uusia näkökulmia.",
    en: "Creativity reveals new perspectives.",
  },
  essenceText: [
    {
      fi: "Taidehuone ei ole täydellisten asioiden luomista.",
      en: "The Art Room is not about creating perfect things.",
    },
    {
      fi: "Se on tuttujen asioiden näkemistä uudella tavalla.",
      en: "It is about seeing familiar things differently.",
    },
  ],
  journey: [
    ...
    { title: { fi: "Pohdinta", en: "Reflection" }, description: { fi: "Ast u askel taaksepäin ja katso.", en: "Step back and observe." } },
  ...
  artifact: {
    ...
    description: [
      { fi: "Luonnoskirja ensimmäisille ideoille, muistiinpanoille ja keskeneräisille mestariteoksille.", en: "A sketchbook for first ideas, notes, and unfinished masterpieces." },
    ],
  },
  unlocks: [
    ...
    { label: { fi: "Tar inakronikka", en: "Story Chronicle" }, description: { fi: "Lore, luonnokset ja luojan ajatukset", en: "Lore, sketches and creator's thoughts" } },
    ...
    { label: { fi: "Tar inamerkintä", en: "Lore Entry" }, description: { fi: "Lisätty kartanon kirjastoon", en: "Added to your Manor Library" } },
  ],
